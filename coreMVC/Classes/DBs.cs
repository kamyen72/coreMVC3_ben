namespace CoreMVC3.Classes
{
    ...
    public static class db_togelking
    {
    ...
    public static class db_local_support
    {
    ...
    public static class db_ghlstaging
    {
