    ...
    public class APIController : ControllerBase
    {
        ...
        public IActionResult GetOverallByBetType([FromBody] OverallByBetTypeInput model)
        {
            ...
            for (int i = 0; i < maxrows; i++)
            {
                ...
                dat.OpeningTime = DateTime.Parse( row["Openning_Time"].ToString() );
        ...
        [HttpPost]
        public IActionResult GenExcel_OverallL1([FromBody] InputModel model)
        {
            var newstr = model.InputText;
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                for (int j = 0; j < datalen; j++)
                {
                    OverallWith_BetType_TicketNo_User d = myjson.Data[j];
                ...
                {
                    OverallWith_BetType_TicketNo_User d = myjson.Data[j];
                    ws.Cell(i, c).Value = decimal.Parse(d.MemberWinLose.ToString());
                    ws.Cell(i, c).Style.NumberFormat.Format = format;
                    ws.Cell(i, c).Style.Font.SetFontSize(12)
                    .Font.SetFontName("Arial");

                    TotalMemberWL = TotalMemberWL + decimal.Parse(d.MemberWinLose.ToString());
                    i++;
                }
                ...
                {
                    OverallWith_BetType_TicketNo_User d = myjson.Data[j];
                    ws.Cell(i, c).Value = decimal.Parse(d.AgentWinLose.ToString());
                    ws.Cell(i, c).Style.NumberFormat.Format = format;
                    ws.Cell(i, c).Style.Font.SetFontSize(12)
                    .Font.SetFontName("Arial");

                    TotalAgentWL = TotalAgentWL + decimal.Parse(d.AgentWinLose.ToString());
                    i++;
                }
                ...
                {
                    OverallWith_BetType_TicketNo_User d = myjson.Data[j];
                    ws.Cell(i, c).Value = decimal.Parse(d.ComWinLose.ToString());
                    ws.Cell(i, c).Style.NumberFormat.Format = format;
                    ws.Cell(i, c).Style.Font.SetFontSize(12)
                    .Font.SetFontName("Arial");

                    TotalComWL += decimal.Parse(d.ComWinLose.ToString());
                    i++;
                }
                ...
                {
                    OverallWith_BetType_TicketNo_User d = myjson.Data[j];
                    ws.Cell(i, c).Value = decimal.Parse(d.MAWinLose.ToString());
                    ws.Cell(i, c).Style.NumberFormat.Format = format;
                    ws.Cell(i, c).Style.Font.SetFontSize(12)
                    .Font.SetFontName("Arial");

                    TotalMAWL += decimal.Parse(d.MAWinLose.ToString());
                    i++;
                }
                ...
                {
                    OverallWith_BetType_TicketNo_User d = myjson.Data[j];
                    ws.Cell(i, c).Value = decimal.Parse(d.SMWinLose.ToString());
                    ws.Cell(i, c).Style.NumberFormat.Format = format;
                    ws.Cell(i, c).Style.Font.SetFontSize(12)
                    .Font.SetFontName("Arial");

                    TotalSMWL += decimal.Parse(d.SMWinLose.ToString());
                    i++;
                }
        ...
        public IActionResult GenExcel_OverallL2([FromBody] InputModel model)
        {
            ...
            for (int j = 0; j < myjson.Data.Count; j++)
            {
                ...
                edt.OpeningTime = dd.OpeningTime;
                ...
                edt.abc = dd.UserName + "-" + dd.BillNo + "-" + dd.OpeningTime;
                SearchList.Add(edt);
            }
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                {
                    OverallByAccount d = myjson.Data[j];
                    ws.Cell(i, c).Value = DateTime.Parse(d.OpeningTime.ToString());
